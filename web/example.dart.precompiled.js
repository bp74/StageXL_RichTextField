...
CanvasRenderingContext2D: {"": "CanvasRenderingContext;font}", $isCanvasRenderingContext2D: true, "%": "CanvasRenderingContext2D"},
...
["", "example.dart", , U, {
main: function() {
  var canvas, textarea, reload, stage, t1, t2, render, format, excited, rtf;
  canvas = document.querySelector("#richtext");
  textarea = document.querySelector("#texttodraw");
  reload = document.querySelector("#reload");
  stage = Z.Stage$(canvas, 4294967295, 30, null, true, null);
  ...
  t2 = P.List_List(null, Z.Stage);
  H.setRuntimeTypeInfo(t2, [Z.Stage]);
  render = new Z.RenderLoop(t1, t2, -1, null, false, new Z.EnterFrameEvent(0, "enterFrame", false, 2, null, null, false, false), new Z.ExitFrameEvent("exitFrame", false, 2, null, null, false, false), new Z.RenderEvent("render", false, 2, null, null, false, false));
  render._renderTime = -1;
  render._requestAnimationFrame$0(render);
  ...
  t2 = rtf.presets;
  t2.$indexSet(t2, "excited", excited);
  rtf.set$text(rtf, J.get$value$x(textarea));
  rtf._width = stage._sourceWidth;
  rtf._refreshPending = (rtf._refreshPending | 3) >>> 0;
  rtf._height = stage._sourceHeight;
  rtf._refreshPending = (rtf._refreshPending | 3) >>> 0;
  rtf._wordWrap = true;
  rtf._refreshPending = (rtf._refreshPending | 3) >>> 0;
  rtf.set$y(rtf, 0);
  render.addStage$1(stage);
  stage.addChildAt$2(rtf, stage._children.length);
  reload.toString;
  t2 = C.EventStreamProvider_click.forElement$1(reload);
  t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new U.main_closure(textarea, rtf)), t2._useCapture);
...
_color2rgba: function(color) {
  ...
  t1 = C.JSInt_methods.$shr(color, 16);
  t2 = C.JSInt_methods.$shr(color, 8);
  t3 = C.JSInt_methods.$shr(color, 24);
...
Stage: {"": "DisplayObjectContainer;_canvas,_renderContext,_sourceWidth,_sourceHeight,_frameRate,_canvasWidth,_canvasHeight,_contentRectangle,_clientTransformation,_stageTransformation,_renderLoop,_juggler,_focus,_renderState,_stageRenderMode,_stageScaleMode,_stageAlign,_mouseCursor,_mousePosition,_mouseTarget,_touches,_mouseButtons,_touchEventSubscriptions,_children,_mouseChildren,_tabChildren,doubleClickEnabled,mouseEnabled,tabEnabled,tabIndex,_stagexl$_id,_x,_y,_pivotX,_pivotY,_scaleX,_scaleY,_skewX,_skewY,_rotation,_alpha,_visible,_off,_mask,_cacheTexture,_cacheRectangle,_cacheDebugBorder,_filters,_shadow,_compositeOperation,_stagexl$_name,_parent,_tmpMatrix,_transformationMatrix,_transformationMatrixRefresh,userData,_eventStreams",
  ...
  _onMouseEvent$1: function($event) {
    var t1, time, button, stagePoint, mouseButton, target, p, oldTargetList, newTargetList, p0, t2, commonCount, t3, ot, nt, i, target0, mouseEventType, isClick, isDoubleClick, localPoint;
    ...
    if (p == null ? target != null : p !== target) {
      ...
      if (p != null) {
        t1 = new Z.MouseEvent(0, 0, 0, 0, 0, 0, false, false, false, false, false, 0, "mouseOut", true, 2, null, null, false, false);
      ...
      for (i = 0; i < oldTargetList.length - commonCount; ++i) {
        ...
        t1 = new Z.MouseEvent(0, 0, 0, 0, 0, 0, false, false, false, false, false, 0, "rollOut", false, 2, null, null, false, false);
      ...
      for (i = newTargetList.length - commonCount - 1; i >= 0; --i) {
        ...
        t1 = new Z.MouseEvent(0, 0, 0, 0, 0, 0, false, false, false, false, false, 0, "rollOver", false, 2, null, null, false, false);
        t2 = target0.globalToLocal$1(stagePoint);
        t1._localX = t2._x;
        t1._localY = t2._y;
        t1._stageX = stagePoint._x;
      ...
      if (target != null) {
        t1 = new Z.MouseEvent(0, 0, 0, 0, 0, 0, false, false, false, false, false, 0, "mouseOver", true, 2, null, null, false, false);
  ...
  Stage$6$color$frameRate$height$webGL$width: function(canvas, color, frameRate, height, webGL, width) {
    ...
    this._sourceWidth = Z._ensureInt(canvas.width);
    this._sourceHeight = Z._ensureInt(canvas.height);
    this._frameRate = Z._ensureInt(frameRate);
    this._renderContext = webGL && !!window.WebGLRenderingContext ? Z.RenderContextWebGL$(canvas, color) : Z.RenderContextCanvas$(canvas, color);
...
RenderContextCanvas: {"": "RenderContext;_canvasElement,_stagexl$_backgroundColor,_renderingContext,_eventStreams",
  ...
  clear$0: function(_) {
    ...
    t1 = this._stagexl$_backgroundColor;
    t2 = this._renderingContext;
    t3 = this._canvasElement;
    if ((t1 & 4278190080) >>> 0 === 0)
      t2.clearRect(0, 0, t3.width, t3.height);
    else {
      t2.fillStyle = Z._color2rgb0(t1);
      this._renderingContext.fillRect(0, 0, t3.width, t3.height);
    }
  },
  ...
  RenderContextCanvas$2: function(canvasElement, backgroundColor) {
    ...
    renderingContext = this._canvasElement.getContext("2d");
...
RenderContextWebGL: {"": "RenderContext;_canvasElement,_stagexl$_backgroundColor,_renderProgramQuad,_renderProgramTriangle,_renderingContext,_stagexl$_renderTexture,_renderProgram,_maskDepth,_eventStreams",
  get$renderEngine: function() {
    return "WebGL";
  },
  get$viewPortMatrix: function() {
  ...
  renderQuad$3: function(renderTextureQuad, matrix, alpha) {
    ...
    this._updateState$2(t1, renderTextureQuad._stagexl$_renderTexture);
  ...
  _updateState$2: function(renderProgram, renderTexture) {
    ...
    if (renderTexture != null) {
      ...
      if (renderTexture == null ? t1 != null : renderTexture !== t1) {
        ...
        this._stagexl$_renderTexture.activate$2(this, 33984);
      }
    }
  },
...
RenderState: {"": "Object;_renderContext,_currentTime,_deltaTime,_firstContextState,_currentContextState",
  ...
  renderDisplayObject$1: function(displayObject) {
    var matrix, alpha, composite, cs1, cs2, nextMatrix, t1, nextCompositeOperation;
...
RenderTexture: {"": "Object;_stagexl$_width,_stagexl$_height,_transparent,_storePixelRatio,_storeWidth,_storeHeight,_canvas,_quad,_texture,_renderingContext,_contextRestoredSubscription",
  resize$2: function(_, width, height) {
    if (width !== this._stagexl$_width || height !== this._stagexl$_height) {
      ...
      J.set$width$x(this._canvas, C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(this._storeWidth / $.get$_backingStorePixelRatio())));
      J.set$height$x(this._canvas, C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(this._storeHeight / $.get$_backingStorePixelRatio())));
  ...
  RenderTexture$5: function(width, height, transparent, fillColor, storePixelRatio) {
    ...
    if (fillColor !== 0 || !transparent) {
      ...
      context.fillStyle = transparent ? Z._color2rgba(fillColor) : Z._color2rgb0(fillColor);
      context.fillRect(0, 0, canvasWidth, canvasHeight);
    }
  },
  static: {
RenderTexture$: function(width, height, transparent, fillColor, storePixelRatio) {
...
RenderTextureQuad: {"": "Object;_stagexl$_renderTexture,_uvList,_xyList,_rotation,_offsetX,_offsetY,_textureX,_textureY,_textureWidth,_textureHeight",
  get$drawMatrix: function() {
    var scale, angle, c, s, t1, t2, t3;
    scale = this._stagexl$_renderTexture._storePixelRatio / $.get$_backingStorePixelRatio();
...
RichTextField: {"": "InteractiveObject;_text,_rawText,_textFormats,presets,_autoSize,_wordWrap,_multiline,_background,_border,_parse,_backgroundColor,_borderColor,_maxChars,_width,_height,_textWidth,_textHeight,_textLineMetrics,parser,_refreshPending,_cacheAsBitmap,_cacheAsBitmapCanvas,_renderTexture,doubleClickEnabled,mouseEnabled,tabEnabled,tabIndex,_stagexl$_id,_x,_y,_pivotX,_pivotY,_scaleX,_scaleY,_skewX,_skewY,_rotation,_alpha,_visible,_off,_mask,_cacheTexture,_cacheRectangle,_cacheDebugBorder,_filters,_shadow,_compositeOperation,_stagexl$_name,_parent,_tmpMatrix,_transformationMatrix,_transformationMatrixRefresh,userData,_eventStreams",
  ...
  render$1: function(renderState) {
    ...
    if (this._cacheAsBitmap || !renderContext.$isRenderContextCanvas) {
      this._refreshCache$0();
      renderState.renderQuad$1(this._renderTexture._quad);
    } else {
...
function dart_precompiled($collectedClasses) {
  ...
  function main_closure(textarea_0, rtf_1) {
  ...
  function RenderContextCanvas(_canvasElement, _stagexl$_backgroundColor, _renderingContext, _eventStreams) {
    this._canvasElement = _canvasElement;
    this._stagexl$_backgroundColor = _stagexl$_backgroundColor;
  ...
  function RenderContextWebGL(_canvasElement, _stagexl$_backgroundColor, _renderProgramQuad, _renderProgramTriangle, _renderingContext, _stagexl$_renderTexture, _renderProgram, _maskDepth, _eventStreams) {
    this._canvasElement = _canvasElement;
    this._stagexl$_backgroundColor = _stagexl$_backgroundColor;
    this._renderProgramQuad = _renderProgramQuad;
    this._renderProgramTriangle = _renderProgramTriangle;
    this._renderingContext = _renderingContext;
    this._stagexl$_renderTexture = _stagexl$_renderTexture;
  ...
  function RenderTextureQuad(_stagexl$_renderTexture, _uvList, _xyList, _rotation, _offsetX, _offsetY, _textureX, _textureY, _textureWidth, _textureHeight) {
    this._stagexl$_renderTexture = _stagexl$_renderTexture;
  ...
  function Rectangle0(_x, _y, _stagexl$_width, _stagexl$_height) {
    this._x = _x;
    this._y = _y;
    this._stagexl$_width = _stagexl$_width;
    this._stagexl$_height = _stagexl$_height;
  ...
  function RichTextField(_text, _rawText, _textFormats, presets, _autoSize, _wordWrap, _multiline, _background, _border, _parse, _backgroundColor, _borderColor, _maxChars, _width, _height, _textWidth, _textHeight, _textLineMetrics, parser, _refreshPending, _cacheAsBitmap, _cacheAsBitmapCanvas, _renderTexture, doubleClickEnabled, mouseEnabled, tabEnabled, tabIndex, _stagexl$_id, _x, _y, _pivotX, _pivotY, _scaleX, _scaleY, _skewX, _skewY, _rotation, _alpha, _visible, _off, _mask, _cacheTexture, _cacheRectangle, _cacheDebugBorder, _filters, _shadow, _compositeOperation, _stagexl$_name, _parent, _tmpMatrix, _transformationMatrix, _transformationMatrixRefresh, userData, _eventStreams) {
    this._text = _text;
  ...
  function RichTextField_defaultParser_closure(box_0, formatRanges_1) {
    this.box_0 = box_0;
    this.formatRanges_1 = formatRanges_1;
  }
  RichTextField_defaultParser_closure.builtin$cls = "RichTextField_defaultParser_closure";
  if (!"name" in RichTextField_defaultParser_closure)
    RichTextField_defaultParser_closure.name = "RichTextField_defaultParser_closure";
  $desc = $collectedClasses.RichTextField_defaultParser_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RichTextField_defaultParser_closure.prototype = $desc;
  function RichTextField_defaultParser__closure() {
  }
  RichTextField_defaultParser__closure.builtin$cls = "RichTextField_defaultParser__closure";
  if (!"name" in RichTextField_defaultParser__closure)
    RichTextField_defaultParser__closure.name = "RichTextField_defaultParser__closure";
  $desc = $collectedClasses.RichTextField_defaultParser__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RichTextField_defaultParser__closure.prototype = $desc;
  function RichTextField_defaultParser_closure0(box_0, this_2) {
    this.box_0 = box_0;
    this.this_2 = this_2;
  }
  RichTextField_defaultParser_closure0.builtin$cls = "RichTextField_defaultParser_closure0";
  if (!"name" in RichTextField_defaultParser_closure0)
    RichTextField_defaultParser_closure0.name = "RichTextField_defaultParser_closure0";
  $desc = $collectedClasses.RichTextField_defaultParser_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RichTextField_defaultParser_closure0.prototype = $desc;
  function RichTextField_getFormatAt_closure(index_0) {
    this.index_0 = index_0;
  }
  RichTextField_getFormatAt_closure.builtin$cls = "RichTextField_getFormatAt_closure";
  if (!"name" in RichTextField_getFormatAt_closure)
    RichTextField_getFormatAt_closure.name = "RichTextField_getFormatAt_closure";
  $desc = $collectedClasses.RichTextField_getFormatAt_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RichTextField_getFormatAt_closure.prototype = $desc;
  function RichTextField_getFormatAt_closure0(this_1) {
    this.this_1 = this_1;
  }
  RichTextField_getFormatAt_closure0.builtin$cls = "RichTextField_getFormatAt_closure0";
  if (!"name" in RichTextField_getFormatAt_closure0)
    RichTextField_getFormatAt_closure0.name = "RichTextField_getFormatAt_closure0";
  $desc = $collectedClasses.RichTextField_getFormatAt_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RichTextField_getFormatAt_closure0.prototype = $desc;
  ...
  function RichTextField__refreshTextLineMetrics_closure0(lineIndex_1, lineEndIndex_2) {
    this.lineIndex_1 = lineIndex_1;
    this.lineEndIndex_2 = lineEndIndex_2;
  }
  RichTextField__refreshTextLineMetrics_closure0.builtin$cls = "RichTextField__refreshTextLineMetrics_closure0";
  if (!"name" in RichTextField__refreshTextLineMetrics_closure0)
    RichTextField__refreshTextLineMetrics_closure0.name = "RichTextField__refreshTextLineMetrics_closure0";
  $desc = $collectedClasses.RichTextField__refreshTextLineMetrics_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RichTextField__refreshTextLineMetrics_closure0.prototype = $desc;
  ...
  function RichTextFormat(font, size, color, startIndex, endIndex, bold, italic, underline, strikethrough, overline, align, topMargin, bottomMargin, leftMargin, rightMargin, indent, leading) {
    this.font = font;
    this.size = size;
    this.color = color;
  ...
  RichTextFormat.prototype.set$font = function(receiver, v) {
    return this.font = v;
  };
  RichTextFormat.prototype.get$size = function(receiver) {
    return this.size;
  };
  RichTextFormat.prototype.set$size = function(receiver, v) {
    return this.size = v;
  };
  RichTextFormat.prototype.get$color = function(receiver) {
    return this.color;
  };
  RichTextFormat.prototype.set$color = function(receiver, v) {
    return this.color = v;
  };
  ...
  RichTextFormat.prototype.set$bold = function(v) {
    return this.bold = v;
  };
  RichTextFormat.prototype.set$italic = function(v) {
    return this.italic = v;
  };
  RichTextFormat.prototype.set$underline = function(v) {
    return this.underline = v;
  };
  RichTextFormat.prototype.set$strikethrough = function(v) {
    return this.strikethrough = v;
  };
  RichTextFormat.prototype.set$overline = function(v) {
    return this.overline = v;
  };
  ...
  function RichTextLineMetrics(_text, _textIndex, _stagexl_richtextfield$_x, _stagexl_richtextfield$_y, _width, _height, _ascent, _descent, _leading, _indent) {
    this._text = _text;
    this._textIndex = _textIndex;
    this._stagexl_richtextfield$_x = _stagexl_richtextfield$_x;
    this._stagexl_richtextfield$_y = _stagexl_richtextfield$_y;
    this._width = _width;
    this._height = _height;
